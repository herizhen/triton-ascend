...
To support the needs of Ascend-level programming, users need to be able to manually create memory (buffer) on a specified address space. This interface is hardware-independent and interfaces with `memref.alloc`.

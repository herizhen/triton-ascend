...
This is only valid in mixed AIC and AIV core usage scenarios. It cannot be used in pure Cube operator or pure Vector operator scenarios; otherwise, a compilation error will be triggered.

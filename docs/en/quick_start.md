...
For different chip types, the corresponding machines can be referred to as follows:

| Option No. | **Chip Type** | Corresponding Machine/Product Series | Typical Server |
| :---: |:-----------------:| :---: |:-----------------------------------:|
...
Kernel functions annotated with `@triton.jit` use the Triton general language and generally do not require special modifications. The Launch grid invocation method is also identical to the GPU version.

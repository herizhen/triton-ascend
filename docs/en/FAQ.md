...
When installing Triton-Ascend, the community Triton is installed first, then Triton-Ascend overwrites the same-named directory, thus preventing subsequent installations of other packages that depend on Triton from overwriting Triton-Ascend.

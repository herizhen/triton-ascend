...
Before performing automatic parameter parsing, the system first obtains the parameters **not passed** during the `kernel` function call. **These unpassed parameters are considered candidates for split axis and tiling axis parameters**.

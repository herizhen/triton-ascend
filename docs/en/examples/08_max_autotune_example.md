...
Users can explicitly specify the compiler options to be tuned and their value lists via **tuning_params**; unspecified parameters will use built-in default values. The following example demonstrates combinatorial search for multiple parameters.

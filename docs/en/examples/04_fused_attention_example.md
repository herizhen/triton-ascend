...
And is wrapped as a callable `attention` function via PyTorch `autograd.Function`, with accuracy alignment verification against `torch_npu.npu_fusion_attention`.

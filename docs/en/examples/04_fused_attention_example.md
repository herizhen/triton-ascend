...
This section implements a **Triton**-based **Flash Attention v2 style fused attention forward kernel**, targeting the Ascend NPU platform. This implementation supports:

...
- [`tutorial/best_practice/003-fused-cat-slice-conv1d.zh.md`](https://github.com/Ascend/triton-ascend-ops/blob/main/tutorial/best_practice/003-fused-cat-slice-conv1d.zh.md): Demonstrates how to use `insert_slice`, transpose, and sub-kernel optimization to reduce discrete memory access and padding overhead when fusing cat, slice, and conv1d update.
...
5. **Sub-kernel Layer**: CV fusion operators typically launch grids based on the number of Cube Cores; at runtime, Vector Cores collaborate at approximately a 1:2 ratio. Do not simply reuse the large grid patterns from GPU.
...
- Load rearrangement under discrete KV cache indexing.

...
- **Number of Cores**: The number of physical Vector Cores on an NPU is typically a few dozen. When migrating GPU code with small tiles and large grids to NPU, the overhead from multiple rounds of dispatch can be significant.

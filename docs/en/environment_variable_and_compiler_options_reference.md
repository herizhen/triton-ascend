...
| **Runtime & Scheduling** | ENABLE_PRINT_UB_BITS | 0 or unset | When enabled, allows retrieving the current UB usage, for use by the inductor. | 0: Disable<br>1: Enable | |
...
| **CV Fusion** | `enable_auto_bind_sub_block` | `None`, `True`, `False` | Enables or disables automatic binding of sub-blocks. | `triton.Config` or launch meta-parameter |

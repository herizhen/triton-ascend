...
| **Debug & Logging** | TRITON_KERNEL_DUMP | 0 or unset | Enables or disables the dumping functionality for Triton kernels. When enabled, Triton saves the generated kernel code (IR at each compilation stage and final PTX) to a specified directory. | 0: Disable<br>1: Enable | |

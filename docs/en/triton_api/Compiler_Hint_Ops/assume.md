...
`assume` is used to provide conditional assumption information to the compiler, allowing it to optimize based on conditions known to be true. This is a compiler hint operation and does not check conditions at runtime.

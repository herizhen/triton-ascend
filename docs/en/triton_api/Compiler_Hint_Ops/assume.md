...
|-----------|------|---------|-------------|
| `cond` | `bool` | Required | The conditional expression that the compiler can assume to be true |
...
def basic_assume_example(x_ptr, y_ptr, BLOCK_SIZE: tl.constexpr):
    # Assume BLOCK_SIZE is a power of two, the compiler can optimize division based on this
    ...
    # The compiler knows BLOCK_SIZE is a power of two, can optimize division into shift operations

...
The following example performs element-wise selection based on the condition `X < Y`: takes the element from `X` when the condition is true, otherwise takes the constant `1`.

...
| `axis` | `int` | Specifies the dimension along which to perform the reduction; when axis=None, reduction is performed over all axes |
...
| -------- | ---------------------- |
| GPU | No limit |
| Ascend A2/A3 | No limit (default maximum 8 dimensions) |

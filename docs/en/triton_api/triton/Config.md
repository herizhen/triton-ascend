...
- **num_stages** – The number of stages the compiler should use when software-pipelining loops. Particularly useful for matrix multiplication workloads on SM80+ GPUs.

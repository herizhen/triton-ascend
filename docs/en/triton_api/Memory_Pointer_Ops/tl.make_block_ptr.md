...
| ---------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------- |
| Generalization issues when used with branch/loop statements | Currently, `tl.make_block_ptr` may cause compilation issues when used with complex loop and branch statements | Expose issues through extensive generalization testing, resolve iteratively |

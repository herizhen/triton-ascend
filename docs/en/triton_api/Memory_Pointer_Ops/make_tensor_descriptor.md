...
| Unsupported `padding_option` parameter | The current community main branch adds the `padding_option` parameter for out-of-bounds element padding strategies. | Can be supported via software development                                |

...
Description: This function computes the element-wise fast square root of `x`.
...
| `_semantic`    | -         | Reserved parameter, not supported for external calls yet |
...
The following example demonstrates computing the element-wise fast square root of the input tensor `x`:

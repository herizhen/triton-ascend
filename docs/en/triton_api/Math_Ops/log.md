...
Description: This function computes the element-wise natural logarithm of x.
...
The following example demonstrates computing the element-wise natural logarithm of the input tensor `x`:

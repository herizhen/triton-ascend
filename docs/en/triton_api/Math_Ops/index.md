...
|[neg](./neg.md) | Negates the values of the tensor. |   x
...
|[div_rn](./div_rn.md) | Computes the element-wise exact division of x and y (rounds to nearest according to IEEE standard) |
...
|[sqrt_rn](./sqrt_rn.md) | Computes the element-wise exact square root of x (rounds to nearest according to IEEE standard) |

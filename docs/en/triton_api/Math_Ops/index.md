...
|[div_rn](./div_rn.md) | Computes the element-wise exact division of x and y (rounded to nearest value per IEEE standard) |
...
|[sqrt_rn](./sqrt_rn.md) | Computes the element-wise exact square root of x (rounded to nearest value per IEEE standard) |

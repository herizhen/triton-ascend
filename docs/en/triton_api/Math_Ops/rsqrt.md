...
> Relative community capability gap and cannot be implemented

None.

### 2.4 Usage Example

The following example demonstrates computing the element-wise reciprocal square root of the input tensor `x`:

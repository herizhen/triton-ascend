...
Description: Inserts a tensor (sub-tensor) into another tensor at specified positions, i.e., inserting one tensor into another according to the specified offsets, sizes, and strides parameters.
Prototype:

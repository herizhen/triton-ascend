...
Description: Inserts a tensor (sub-tensor) into another tensor at a specified position, i.e., inserts one tensor into another according to the specified offset, size, and stride parameters.
Prototype:
...
Supports tensors of arbitrary shapes, subject to the following constraints:

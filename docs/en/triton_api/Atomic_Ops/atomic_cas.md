...
| -------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `pointer`      | `triton.PointerDType` | Memory location to operate on. If *pointer == cmp, updates *pointer to `val`. The computed result is written back to this memory. |

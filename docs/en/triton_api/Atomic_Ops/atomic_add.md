...
| scope            | Accepts "gpu", "cta", or "sys"<br>We only support "gpu"                               |

### 2.4 Usage Example

The following example implements an atomic addition computation:

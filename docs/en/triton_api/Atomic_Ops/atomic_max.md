...
| `scope` | `str`, optional | The thread scope for observing the synchronization effect of the atomic operation<br>Acceptable values: "gpu" (default), "cta" (cooperative thread array, thread block), or "sys" (representing "SYSTEM")<br>We only support "gpu" |
...
| scope | Acceptable values: "gpu", "cta", or "sys"<br>We only support "gpu" |

...
| ------------- | ----------------- | -------------------------------------------------------------- |
| `pointer`        | `triton.PointerDType`          | The memory location to operate on, where the result of *pointer ^ val is written back                                                     |
| `val`       | `pointer.dtype.element_ty`    | The value for the atomic XOR operation (right operand)                                                        |
...
> Relative to community capabilities, missing and not implementable

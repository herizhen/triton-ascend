...
Description: Atomic logical XOR operation, performs a logical XOR at the specified memory location.
Prototype:
...
| `val`         | `pointer.dtype.element_ty` | The value used for the atomic XOR operation (right operand).                                                                          |
...
> Differences from the community version that cannot be implemented.

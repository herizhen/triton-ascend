...
| `_builder` | - | Reserved parameter, not supported for external calls currently |
...
Conclusion: Compared to GPU, Ascend lacks support for uint16/uint32/uint64 and fp64.

...
Description: `triton.language.cumsum` computes the cumulative sum of the input tensor along the specified axis and returns the cumulative summation result.
